...
-- train model flic
os.execute(('CUDA_VISIBLE_DEVICES=0 th train.lua -dataset flic -expID %s -netType %s'..
    ...
    ' -rotRate %0.2f -nStack %d -nFeats %d -scale %0.2f -batchSize %d -saveBest \'false\'')
