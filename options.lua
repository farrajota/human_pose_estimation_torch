...
local function Parse(arg)
    ...
    cmd:option('-dataset',        'flic', 'Dataset choice: mpii | flic | lsp | coco | mpii+lsp')
    ...
    cmd:option('-alpha',            0.99, 'rmsprop: Alpha - smoothing constant')
    ...
    cmd:option('-scale',            0.25, 'Degree of scale augmentation')
