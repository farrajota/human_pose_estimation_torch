...
local function Parse(arg)
    ...
    cmd:option('-dataset',        'lsp', 'Dataset choice: mpii | flic | lsp | coco | lsp+mpii')
    ...
    cmd:option('-testIters',        300, 'Number of test batches/iterations used for accuracy validation per epoch')
    ...
    cmd:text()
    cmd:option('-subpixel_precision',   "false", 'Compute parts x,y coordinate using sub-pixel precision (parabola fitting).')
    cmd:text()
