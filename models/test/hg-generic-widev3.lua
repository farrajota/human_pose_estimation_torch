...
local function createModel()
    ...
    -- Output heatmaps
    local out2 = nn.SpatialConvolution(512,outputDim[2][1],1,1,1,1,0,0)(l4)
    local out2_ = nn.SpatialConvolution(outputDim[2][1],512,1,1,1,1,0,0)(out2)

     -- Concatenate with previous linear features
    local cat2 = nn.JoinTable(2)({l4,pool})
    ...
    local l6 = lin(512,512,l5)

    -- Output heatmaps
    local out3 = nn.SpatialConvolution(512,outputDim[2][1],1,1,1,1,0,0)(l6)


    -- Final model
    local model = nn.gModule({inp}, {out1,out2, out3})
