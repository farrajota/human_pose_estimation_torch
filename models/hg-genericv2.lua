-- Has dropout/spatial dropout in the middle of the residual block

if opt.dropout > 0 then
    paths.dofile('layers/ResidualDropout.lua')
elseif opt.spatialdropout > 0 then
    paths.dofile('layers/ResidualSpatialDropout.lua')
else
