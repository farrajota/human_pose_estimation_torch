...
local function Parse(arg)
    ...
    cmd:option('-expID',       'hg-stacked-wide', 'Experiment ID')
    ...
    cmd:option('-genGraph',            0, 'Generate a graph of the network and save it to disk. 1 - Generate graph. 0 - Skip graph generation.')
    cmd:text()
    ...
    cmd:option('-trainIters',       400, 'Number of train iterations per epoch')
